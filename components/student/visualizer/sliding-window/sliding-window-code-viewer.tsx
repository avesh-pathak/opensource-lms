...
export function SlidingWindowCodeViewer() {
  const { algorithm, frames, currentFrame } = useSlidingWindowStore()
              ...
              <div
                ...
                className={cn(
                  ...
                  idx + 1 === activeLineIndex
                    ? 'bg-yellow-500/10 text-yellow-600 dark:text-yellow-300 shadow-[inset_2px_0_0_0_#eab308]'

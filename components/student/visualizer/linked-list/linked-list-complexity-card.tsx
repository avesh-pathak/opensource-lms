...
export function LinkedListComplexityCard() {
  const { algorithm } = useLinkedListStore()
  const data = ALGORITHM_DATA[algorithm as keyof typeof ALGORITHM_DATA]

  if (!data)
    return (
      <div className="p-6 bg-white/60 dark:bg-black/40 rounded-3xl border border-white/40 dark:border-white/10 backdrop-blur-xl">

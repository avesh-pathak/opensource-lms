...
export function QueueInputControls() {
  const { algorithm: _algorithm, generateInput } = useQueueStore()
  ...
  return (
    <div className="flex items-center gap-2 bg-white/40 dark:bg-white/5 p-1.5 rounded-2xl border border-zinc-200 dark:border-white/10 backdrop-blur-sm">
      <Button
        ...
        className="h-8 rounded-xl text-xs font-bold gap-2 hover:bg-orange-500/10 hover:text-orange-500 transition-all"
      >

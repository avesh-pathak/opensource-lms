...
export function StackCodeViewer() {
  const { algorithm, frames, currentFrame } = useStackStore()
              ...
              <div
                ...
                className={cn(
                  ...
                  idx + 1 === activeLineIndex
                    ? 'bg-indigo-500/10 text-indigo-600 dark:text-indigo-300 shadow-[inset_2px_0_0_0_#6366f1]'

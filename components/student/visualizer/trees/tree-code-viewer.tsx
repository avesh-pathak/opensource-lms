...
export function TreeCodeViewer() {
  const { algorithm, frames, currentFrame } = useTreeStore()
              ...
              <div
                ...
                className={cn(
                  ...
                  idx + 1 === activeLineIndex
                    ? 'bg-emerald-500/10 text-emerald-600 dark:text-emerald-300 shadow-[inset_2px_0_0_0_#10b981]'

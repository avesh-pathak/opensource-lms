...
export function ExplanationPanel() {
  const { frames, currentFrame, target } = useVisualizerStore()
  ...
  return (
    <div className="flex flex-col gap-3 p-5 rounded-3xl border border-white/40 dark:border-white/20 bg-white/60 dark:bg-zinc-900/80 backdrop-blur-xl shadow-xl transition-all hover:bg-white/70 dark:hover:bg-zinc-900/90">
      {/* Header / Status Icon */}
        ...
        <div className="flex flex-col items-center">
          {target !== null && (
            <>
              ...
              <span className="font-mono text-xl font-bold text-orange-600 dark:text-orange-400 tracking-widest">
                {target}
              </span>
            </>
          )}
